...
public class CheckIdCurentRepository {
    private static CheckIdCurentRepository instance;

    public static CheckIdCurentRepository getInstance() {
        if (instance == null)
            instance = new CheckIdCurentRepository();
        return instance;
    }
    ...
    public MutableLiveData<ServerResponse> getMutableLiveData(Map<String, String> params) {
        ...
        try {
            ...
            dataService.checkIdCurent(params).enqueue(new Callback<ServerResponse>() {
                @Override
